	...
	<div class="ticket-table">
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				...
				<td><?php echo $html->link($ticket['Ticket']['packageId'], array('controller'=> 'clients/' . $ticket['Client'][0]['Client']['clientId'], 'action'=> '/packages/summary/' . $ticket['Ticket']['packageId'])); ?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<?php $altRow=true; foreach ($ticket['Call'] as $call): $altRow = !$altRow; ?>
						<div class="<?php echo $altRow?'altRow':''?> ticketCallLog">
							<div class="ticketCallLogNotes"><?php echo str_replace("\n","<br/>",htmlentities($call['notes'])); ?></div>
							<div class="ticketCallLogInfo"><div style="float: right;"><?php echo $call['representative']; ?></div>Call #<?php echo $call['callId']; ?>, <?php echo $call['created']; ?></div>
						</div>
					<?php endforeach; ?>
				</td>
			</tr>
