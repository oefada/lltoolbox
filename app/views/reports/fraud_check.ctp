...
<?php $this->pageTitle = "Suspicious Credit Card Activity (past 30 days)" ?>
...
<?  $count = 0;
	...
	<tr style="background-color: #<?= $bgColor; ?>";>
		<td align="center"><a href="/tickets/view/<?= $r['p']['ticketId']; ?>"><?= $r['p']['ticketId']; ?></a></td>
		<td align="right"><?= $r[0]['declinedCount']; ?></td>
		<td align="right"><?= $r[0]['declinedLast']; ?></td>		
		<td align="right"><?= $r['f']['dateCleared']; ?> <?= $r['f']['clearedBy']; ?></td>
		<td align="center">
			<? if (!$ticketCleared) { ?>
				<a href="/reports/fraud_check?c=<?= $r['p']['ticketId']; ?>">CLEAR TICKET</a>
			<? } ?>
		</td>
	</tr>
<? } ?>
