...
<script type="text/javascript">
    tinyMCE.init({
        ...
        theme : "advanced",
        language:'en',
        theme_advanced_buttons1 : "youtubeIframe,mybutton,bold,italic,underline,blockquote,separator,strikethrough,justifyleft,justifycenter,justifyright, justifyfull,bullist,numlist,undo,redo,link,unlink,code,iframe,cleanup,paste",
        ...
        entity_encoding : "raw",
        extended_valid_elements : "iframe[src|title|width|height|allowfullscreen|frameborder|class|id],object[classid|width|height|codebase|*],param[name|value|_value|*],embed[type|width|height|src|*],img[class|src|border=0|alt|title|hspace|vspace|width|height|align|onmouseover|onmouseout|name]",
    ...
    tinyMCE.init({
        ...
        theme : "advanced",
        theme_advanced_buttons1 : "youtubeIframe,mybutton,bold,italic,underline,blockquote,separator,strikethrough,justifyleft,justifycenter,justifyright, justifyfull,undo,redo,link,unlink,code,iframe,cleanup,paste",
        theme_advanced_buttons2 : "",
        theme_advanced_buttons3 : "",
        theme_advanced_toolbar_location : "top",
        theme_advanced_toolbar_align : "left",
