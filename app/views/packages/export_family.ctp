...
<tr class="bold">
	<td width="20%" style="background-color:#b3ff85;">Package Level:</td>
	<td width="50%" style="background-color:#b3ff85;"><?=($package['Package']['isBarter']) ? 'Barter' : 'Remit';?></td>
	<td width="20%" style="background-color:#feffcb;">Client ID (internal use):</td>
