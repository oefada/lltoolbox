...
<?=$form->input('PackageOfferTypeDefField.4.buyNowPrice', array('label' => 'Request Price', 'size' => 5)) ?>
...
<?=$form->input('PackageOfferTypeDefField.3.buyNowPrice', array('label' => 'Request Price', 'size' => 5)) ?>
