...
<form id="inclusionsForm">
    ...
    <tr>
        <td colspan="5"><div class="section-title">Included in this Package</div></td>
    </tr>
    <tr>
        <th width="400">&nbsp;</th>
        <th>LOA Item Type</th>
    ...
    <?php if (!empty($roomLabel)): ?>
        <tr class="odd">
            <td class="item-name" colspan="5">
                <?php echo $numNights; ?> nights in <?php echo $roomLabel; ?>
            </td>
        </tr>
    <?php endif; ?>
    ...
    <?php if (!empty($availableInclusions)): ?>
        <table class="add-inclusions">
            ...
            <tr>
                <td id="available-inclusions" colspan="4">
                    <?php echo $this->element('package/available_inclusions', array('availableInclusions' => $availableInclusions, 'i' => $i)); ?>
                </td>
            </tr>
        </table>
    <?php endif; ?>
