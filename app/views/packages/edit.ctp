...
<div class="packages form">
	...
	<?=$html->link('<span>Preview as Package</span>', "http://{$siteUrl}/luxury-hotels/preview.html?clid={$this->data['ClientLoaPackageRel'][0]['clientId']}&preview=package&multiPackages={$this->data['Package']['packageId']}", array('target' => '_blank', 'class' => 'button'), null, false)?>
