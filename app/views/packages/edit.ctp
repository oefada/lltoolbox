...
<div class="packages form">
	...
	<?=$html->link('<span>Preview as Auction</span>', "http://{$siteUrl}/luxury-hotels/preview.html?clid={$this->data['ClientLoaPackageRel'][0]['clientId']}&oid={$this->data['Package']['packageId']}&preview=package", array('target' => '_blank', 'class' => 'button'), null, false)?>
