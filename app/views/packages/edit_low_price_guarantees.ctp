            ...
            foreach ($ratePeriods as $key => $ratePeriod) {
                ...
                echo "
                    <tr $alt>
                       ...
                       <td><input id='percent-retail{$ratePeriod['LoaItemRatePeriod']['loaItemRatePeriodId']}' class='percent-retail' type='text' name='data[LoaItemRatePackageRel][{$ratePeriod['LoaItemRatePackageRel']['loaItemRatePackageRelId']}]' value='{$ratePeriod['LoaItemRatePackageRel']['guaranteePercentRetail']}' style='width:90px;'/></td>
                    </tr>
                ";
            }
        ?>
