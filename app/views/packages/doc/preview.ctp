...
?>
<div style="border-bottom: 1px solid #000;padding: 10px;"><img src="http://www.luxurylink.com/images/shared/ll_logo2.gif" style="width: 250px; height: 35px;"></div>
...
<table class="leftcol" style="width: 100%;">
