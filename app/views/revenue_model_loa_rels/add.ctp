<div class="revenueModelLoaRels form">
	<?php echo $ajax->form('add', 'post', array('url' => "/loas/{$this->data['RevenueModelLoaRel']['loaId']}/revenue_model_loa_rels/add", 'update' => 'MB_content', 'model' => 'RevenueModelLoaRel', 	'complete' => 'closeModalbox()'));?>
	<fieldset>
	<?php
