...
<script type="text/javascript">
	...
	submit_clientNote = function(){
		...
		var v_photoId = $("#photoId").val(); // get clientId
		...
		if( v_message != '' && v_message != 'Enter note here...'){
			$.ajax({
				type: "POST",
				url: v_url,
				data: { message: v_message, photoId: v_photoId },
...
<div id="clientNoteHeader">Photo Notes</div>
...
<div id="clientNote">
	...
	<input type="hidden" id="photoId" name="photoId" value="<?= $clientId; ?>" />
