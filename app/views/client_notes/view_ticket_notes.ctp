...
<script type="text/javascript">
	...
	submit_clientNote = function(){
		...
		var v_ticketId = $("#ticketId").val(); // get clientId
		...
		if( v_message != '' && v_message != 'Enter note here...'){
			$.ajax({
				type: "POST",
				url: v_url,
				data: { message: v_message, ticketId: v_ticketId },
...
<div id="clientNoteHeader">Ticket Notes</div>
...
<div id="clientNote">
	...
	<input type="hidden" id="ticketId" name="ticketId" value="<?= $clientId; ?>" />
