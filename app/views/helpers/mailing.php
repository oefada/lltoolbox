...
class MailingHelper extends AppHelper
{
    ...
    public function genDealHtml2013($clientArr, $utm_content = '', $utm_term = '')
    {
        ...
        <td 
            ...
            border="2" 
            valign="middle" 
            style="background-color: #cccccc; border: 1px solid #e2e2e2;"
        >

            <table id="savigs" align="center" width="110"  border="0" cellpadding="0" cellspacing="0">
            <tr><!--savings-->
            <td 
                width="45" 
                height="34" 
        ...
        <td 
            ...
            bgcolor="#ffffff" 
            valign="bottom"
            style="text-align: right;border: 1px solid #e2e2e2; padding:0px 8px 1px 0px"            
        ><a 
            ...
            target="_blank" 
            ><img 
                src="http://www.luxurylink.com/images/insider/new/view2_btn.jpg" 
                width="98" 
                height="26" 
                border="0"
        />
