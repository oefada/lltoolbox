                            ...
                            <tr>
                                ...
                                <table align="center" width="654" cellspacing="0" cellpadding="" border="0" style="background-color: rgb(255, 255, 255);">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center" style="padding: 5px 0px;"><a name="banner" title="" target="_blank" xt="SPCLICK" href="http://www.familygetaway.com/hotel-deals?nav=new&pp=5&x=63&sortb=bestselling&offerFp=1&utm_medium=news&utm_source=fgnews&utm_campaign=<?= $campaign; ?>&utm_content=spring-outdoors-main-image"><img align="middle" width="660" height="235" border="0" name="Cont_27" style="display: block; border: 1px solid rgb(153, 153, 153);" src="http://www.luxurylink.com/images/ads/insertions/new-and-best-narrow-main.jpg" alt="" /></a></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="400" valign="bottom" height="20" bgcolor="#ffffff" color="#028abd" border="0" colspan="2" style="padding: 10px 0px 10px 0px; font-size: 24px; font-family: Arial,Sans-Serif; color: rgb(2, 138, 189); line-height: 1.5;"><a alt="" target="_blank" href="http://www.familygetaway.com/hotel-deals/low-prices?utm_medium=news&utm_source=fgnews&utm_campaign=<?= $campaign; ?>&utm_content=all-beach" style="text-decoration: none;" name="www_familygetaway_com_vacation" xt="SPCLICK"><span style="color: rgb(2, 138, 189); text-decoration: none;">Newest Properties and Best Sellers</span></a></td>
                                        </tr>
                                        <tr>
                                            <td align="center" valign="top" style="font-size: 14px; font-family: Arial,Sans-Serif; color: rgb(102, 102, 102); line-height: 22px; text-align: left; padding: 0px 0px 10px;">To give you a little inspiration, this week we'd like to present our <a alt="" target="_blank" style="color: #028abd;font-family: Arial,Sans-Serif;text-decoration: underline;" href="http://www.familygetaway.com/hotel-deals/new-packages?utm_medium=news&utm_source=fgnews&utm_campaign=<?= $campaign; ?>_&utm_content=new-properties">Newest Properties</a> and <a alt="" target="_blank" style="color: #028abd;font-family: Arial,Sans-Serif;text-decoration: underline;" href="http://www.familygetaway.com/vacations/hotel-deals?pp=50&pg=1&sortb=bestselling&utm_medium=news&utm_source=fgnews&utm_campaign=<?= $campaign; ?>_&utm_content=best-sellers">Best Sellers</a>. From <a alt="" target="_blank" style="color: #028abd;font-family: Arial,Sans-Serif;text-decoration: underline;" href="http://www.familygetaway.com/hotel-deals?pp=10&x=43&kw=london england&sortb=bestselling&utm_medium=news&utm_source=fgnews&utm_campaign=<?= $campaign; ?>_&utm_content=london">London</a> to Boston, California to the <a alt="" target="_blank" style="color: #028abd;font-family: Arial,Sans-Serif;text-decoration: underline;" href="http://www.familygetaway.com/vacations/deals/caribbean-and-bermuda?pp=10&sortb=bestselling&utm_medium=news&utm_source=fgnews&utm_campaign=<?= $campaign; ?>_&utm_content=caribbean">Caribbean</a>, and Florida to Washington, explore what's new, as well as tried and true, on Family Getaway. And with family hotel packages up to 65% off, it's as good a time as ever to come together for a fabulous getaway!  
<a alt="" target="_blank" href="http://www.familygetaway.com/?utm_medium=news&utm_source=fgnews&utm_campaign=<?= $campaign; ?>&utm_content=all" style="color: rgb(2, 138, 189); font-family: Arial,Sans-Serif; font-size: 14px;line-height: 28px; text-decoration: none;" name="www_familygetaway_com_vacation" xt="SPCLICK"><strong> &nbsp;Plan Your Family Getaway today!
</strong></a></td>
                                        </tr>
                                        <tr colspan="3">
													...
													<tbody>
														<tr>
															...
															<table width="340" height="75" cellspacing="0" cellpadding="0" border="0">
																<tbody>
																	<tr colspan="1">
																		<td width="320" valign="top" style="font-size: 12px; line-height: 13px; font-family: Verdana,Arial,Sans-Serif; color: rgb(68, 68, 68); padding-top: 0px; text-align: left;"><strong><?= $clientName; ?></strong></td>
																	</tr>
																	<tr>
