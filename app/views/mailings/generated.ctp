...
<!--LEADERBOARD-ONE-->
<table align="center" valign="middle" width="800" border="0" cellpadding="0" cellspacing="0" bgcolor="#e9e9e9">

<tr>
    <td align="center" colspan="2" style="padding: 20px 0px 0px 0px;">  <a href="http://ad.doubleclick.net/clk;276830877;102605600;d" name="Mercedes_LB1_10.21.13" target="_blank"><img border="0" width="728" height="90" name="LB1" src="http://www.luxurylink.com/images/ads/insertions/728x90_Mercedes.jpg" alt="Mercedes Ad" /></a>
    <a href="http://ad.doubleclick.net/jump/N6249.126237.LUXURYLINKLLCLUXURY/B7860598.17;sz=1x1;ord=[timestamp]?"><img src="http://ad.doubleclick.net/ad/N6249.126237.LUXURYLINKLLCLUXURY/B7860598.17;sz=1x1;ord=[timestamp]?" border="0" width="1" height="1" /></a></td>
  </tr>
   <tr>
<td valign="top" colspan="2" align="left" style="font-size:9px; font-family: Arial,Sans-Serif;color:#666666;line-height:11px;padding: 0px 0px 10px 20px; vertical-align:top;text-align:center">Advertisement</td>
</tr>
</table>
...
<td colspan="6"
    ...
    <td align="center" valign="top" width="240" height="201">
        <?=$mailing->genDealHtml2013($rows[3]['client']);?>
    </td><!--end product mod 1x-->
    ...
    <!--start product mod2 1x ##-->
    <td align="center" valign="top" width="240" height="202">
        <?=$mailing->genDealHtml2013($rows[4]['client']);?>
    </td>
    ...
    <!--start product mod 3x-->
    <td align="center" valign="top" width="240" height="202">
        <?=$mailing->genDealHtml2013($rows[5]['client']);?>
    </td><!--end product mod 3##-->
...
<table align="center" width="800" height="201" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
    ...
    <!--start product mod 1x ##-->
    <td align="center" valign="top" width="240" height="201">
        <?=$mailing->genDealHtml2013($rows[6]['client']);?>
    </td><!--end product mod 1x-->
    ...
    <!--start product mod2 1x ##-->
    <td align="center" valign="top" width="240" height="202">
        <?=$mailing->genDealHtml2013($rows[7]['client']);?>
    </td>
    ...
    <!--start product mod 3x-->
    <td align="center" valign="top" width="240" height="202">
        <?=$mailing->genDealHtml2013($rows[8]['client']);?>
    </td><!--end product mod 3##-->
...
<table align="center" width="800" height="201" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
    ...
    <!--start product mod 1x ##-->
    <td align="center" valign="top" width="240" height="201">
        <?=$mailing->genDealHtml2013($rows[9]['client']);?>
    </td><!--end product mod 1x-->
    ...
    <!--start product mod2 1x ##-->
    <td align="center" valign="top" width="240" height="202">
        <?=$mailing->genDealHtml2013($rows[10]['client']);?>
    </td>
    ...
    <!--start product mod 3x-->
    <td align="center" valign="top" width="240" height="202">
        <?=$mailing->genDealHtml2013($rows[11]['client']);?>
    </td><!--end product mod 3##-->
...
<table align="center" width="800" height="201" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
    ...
    <!--start product mod 1x ##-->
    <td align="center" valign="top" width="240" height="201">
        <?=$mailing->genDealHtml2013($rows[12]['client']);?>
    </td><!--end product mod 1x-->
    ...
    <!--start product mod2 1x ##-->
    <td align="center" valign="top" width="240" height="202">
        <?=$mailing->genDealHtml2013($rows[13]['client']);?>
    </td>
    ...
    <!--start product mod 3x-->
    <td align="center" valign="top" width="240" height="202">
        <?=$mailing->genDealHtml2013($rows[14]['client']);?>
    </td><!--end product mod 3##-->
...
<tr>
<td  align="left" valign="top" colspan="2" style="padding: 20px 20px 0px 30px;">

<table width="740" cellspacing="0" cellpadding="0" border="0" align="center">

<tbody>
<tr>
<td valign="top" align="center" style="padding: 0px 0px 0px 15px;">

<table  width="350" cellspacing="0" cellpadding="0" border="0" valign="top">
<tbody>
<tr>
<td width="350" valign="top" height="83" style="padding: 0px 0px 15px 0px;">
<a href="<?=$mailing->genUrl('mystery', '/last-minute-travel-deals/mystery-offer', 'mystery_logo');?>" name="mystery_10.21.13" target="_blank"><img border="0" width="300" height="250" name="mystery" src="http://www.luxurylink.com/images/email/Mystery-Auction/mystery1021_NewEngl.jpg" alt="Luxury Link Mystery Auction" /></a>
</td>
</tr>
</tbody>
</table>
...
<tr>
    <td valign="top" align="left" style="padding: 0px 20px 0px 20px; vertical-align:top;">
        <a href="http://www.andrewharpertravel.com/#get-inspired" name="Andrew-Harper_10.21.13" target="_blank"><img border="0" width="300" height="250" name="anchor-bottom"  src="http://www.luxurylink.com/images/ads/insertions/300x250_A-Harper.jpg" alt="Andrew Harper Ad" /></a></td>
</tr>
<tr>
