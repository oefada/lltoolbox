...
class UsersController extends AppController {
	...
	function search()
	{
		...
		if(!empty($this->params['form']['query'])):
			...
			$conditions = array('OR' => array("MATCH(User.lastName,User.firstName,User.email) AGAINST('$query' IN BOOLEAN MODE)", 'User.userId' => $origQuery, 'UserSiteExtended.username LIKE' => "%$origQuery%"));
